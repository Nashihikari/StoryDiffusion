            ...
            if random_number > rand_num:
                ...
                if not write:
                    if hidden_states.shape[1] == (height//32) * (width//32):
                        # take some mask from a mask matrix which was pre-defined
...
# define all partion which you need
...
sd_model_path = models_dict["Animagine"]  #"SG161222/RealVisXL_V4.0"
...
for id_image in id_images:
    ...
    id_image.save(f'./outputs/{i}_id.jpg')
    # print(id_image)
    pdb.set_trace()
    i = i + 1
    print(id_image)
